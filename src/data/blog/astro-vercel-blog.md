...
![](../assets/images/Pasted image 20260402164949.png)

构建成功后会deploy到pages，访问`https://用户名.github.io`即可。

![](../assets/images/Pasted image 20260402164758.png)
## 改变样式
...
![](../assets/images/Pasted image 20260404011329.png)
## 部署到Vercel
...
![](../assets/images/Pasted image 20260404004125.png)
...
![](../assets/images/屏幕截图 2026-04-02 040711 1.png)
回到Vercel配置一下域名和dns解析，即可正常使用。
![](../assets/images/Pasted image 20260415164544.png)